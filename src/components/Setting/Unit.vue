                    ...
                    <!-- /.content-wrapper -->
                        <div class="content-wrapper p-2">
                                    <div class="content-header">
                                        ...
                                        <h2 class="text-md ml-4"><span class="text-lg">Unit List</span>  View / <small class="text-gray text-sm"><span>Search Units </span></small></h2>
                                        <!-- alert start -->
                                        <div class="content-header">
                                        ...
                                        <div class="container-fluid">
                                            <div class="card border-top border-primary">
                                                <div class="card-header">
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <h1 class="display-4">Units List</h1>
                                                                </div> 
                                                ...
                                                <div class="card-body">
                                                    <div class="box-body">
                                                        <!-- Start First Table List -->
                                                            <table  class="table table-bordered table-striped dataTable dtr-inline" width="100%" role="grid"  style="width: 100%;">
                                                            <thead class="bg-primary ">
                                                                <tr role="row">
                                                                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" style="width: 255px;">Unit Name</th>
                                                                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" style="width: 205px;">Description</th>
                                                                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" style="width: 194px;">Status</th>
